...
-- LG DualUp (2560x2880) on top; laptop panel centered underneath it.
hl.monitor({
...
hl.window_rule({ match = { class = "Alacritty" }, size = "1160 823" })
hl.window_rule({ match = { class = "Alacritty" }, move = "266 49" })
